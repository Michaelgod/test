...
import os, random
from rnn_practice.LRCN.UCF_utils import video_generator, get_data_list
...
def fit_model(model, train_data, test_data):
    try:
        if os.path.exists('LRCN_keras.h5'):
            ...
            print('Load weights')
        train_generator = video_generator(train_data, BatchSize, seq_len=SequenceLength, input_shape=IMSIZE, num_classes=101)
...
if __name__ == '__main__':
    data_dir = 'E:/ActionRecognition_rnn/data'
