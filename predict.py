...
def predict_two_stream3_test():
    spatial_weights_dir = 'E:/ActionRecognition/models/finetuned_resnet_RGB_65.h5'
    temporal_weights_dir = 'E:/ActionRecognition/models/finetuned_resnet_flow.h5'
    ...
    data_dir = 'E:/ActionRecognition/data'
    list_dir = os.path.join(data_dir, 'ucfTrainTestlist')
    test_list = os.path.join(list_dir, 'testlist.txt')
    frames_dir = 'E:/ActionRecognition/data/frames'
    flow_images_dir = 'E:/ActionRecognition/data/flow_images'
...
def predict_two_stream18_test():
    spatial_weights_dir = 'E:/ActionRecognition/models/finetuned_resnet_RGB_65.h5'
    temporal_weights_dir = 'E:/ActionRecognition/models/temporal_cnn_42.h5'
    model = two_stream_model(spatial_weights_dir=spatial_weights_dir, temporal_weights_dir=temporal_weights_dir)
    ...
    list_dir = os.path.join(data_dir, 'ucfTrainTestlist')
    test_list = os.path.join(list_dir, 'testlist.txt')
    frames_dir = 'E:/ActionRecognition/data/UCF-Preprocessed-OF/test'
    flow_dir = 'E:/ActionRecognition/data/OF_data/test'
    N_CLASSES = 101
...
def decode_prediction(preds, top=3):
    index_dir = 'E:/ActionRecognition/data/ucfTrainTestlist/classInd.txt'
    class_dict = dict()
...
if __name__ == '__main__':
    ...
    weights_dir = 'E:/ActionRecognition/models'
